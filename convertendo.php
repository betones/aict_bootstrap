...
<head>
    <meta charset="utf-8">
    <title>Instituto Consciência e Trânsito</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="AICT INSTITUTO CONSCIÊNCIA E TRÂNSITO">
    <meta name="author" content="Carlos Alberto Prado">

    <!-- Le styles -->
    <link href='http://fonts.googleapis.com/css?family=PT+Sans:400,700,400italic' rel='stylesheet' type='text/css'>

    <link id="dropper-theme" href="assets/css/bootstrap.min.css" rel="stylesheet">
...
<div class="navbar navbar-inverse navbar-fixed-top navbar-big">
    <div class="navbar-inner">
        <div class="container">
            ...
            <a class="brand" href="http://codecanyon.net/item/dropper-bootstrap-skin/4468902?ref=geedmo">Dropper <span class="nav-description">bootstrap skin</span></a>
                ...
                <ul class="nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="marketing-alternate.html">Marketing</a>
                            </li>
                            <li>
                                <a href="marketing-narrow.html">Marketing Narrow</a>
                            </li>
                            <li>
                    ...
                    <li class="">
                        <a href="http://themeroller.geedmo.com/">Theme Roller<span class="nav-description">exclusive for buyers</span></a>
                    </li>
                </ul>
            </div>
        </div>
...
<footer class="footer">
    ...
    <div class="container">
        <p>
            Dropper skin for <a href="http://twitter.github.com/bootstrap/">Bootstrap</a> Powered by CSS3.
        </p>
        <p>
